...
const (
	TrainService_PurchaseTicket_FullMethodName    = "/train_ticket.TrainService/PurchaseTicket"
	TrainService_GetReceipt_FullMethodName        = "/train_ticket.TrainService/GetReceipt"
	TrainService_GetUsersBySection_FullMethodName = "/train_ticket.TrainService/GetUsersBySection"
	TrainService_RemoveUser_FullMethodName        = "/train_ticket.TrainService/RemoveUser"
	TrainService_ModifySeat_FullMethodName        = "/train_ticket.TrainService/ModifySeat"
)
...
func (c *trainServiceClient) ModifySeat(ctx context.Context, in *ModifySeatRequest, opts ...grpc.CallOption) (*Ticket, error) {
	out := new(Ticket)
...
func (UnimplementedTrainServiceServer) ModifySeat(context.Context, *ModifySeatRequest) (*Ticket, error) {
...
var TrainService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "train_ticket.TrainService",
